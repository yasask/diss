...
import pandas as pd
import csv
links = 'http://www.pornhub.com', 'https://www.youtube.com', 'https://www.stackoverflow.com'
#cj = requests.get(url).cookies
...
with open('new_tmp.csv', 'rb') as f:
    reader = csv.reader(f)
    data_list = [line for line in reader if line[0]]
    data_dict = {line[0]: line[1] for line in data_list}
